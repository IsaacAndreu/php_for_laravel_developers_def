                  ...
                  <div class="flex w-full items-center justify-between space-x-6 p-6">
                     <div class="flex-1 truncate">
                        <div class="flex items-center space-x-3">
                           <h3 class="truncate text-sm font-medium text-gray-900">{{ $usuari->nom }}  {{ $usuari->cognom }}</h3>
                           <span
                                   class="inline-block flex-shrink-0 rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-800">{{ $usuari->role }}</span>
                        </div>
                        <p class="mt-1 truncate text-sm text-gray-500">{{ $usuari->telefon }}</p>
                     </div>
                  ...
                  <div>
                     <div class="-mt-px flex divide-x divide-gray-200">
                        ...
                        <div
                           ...
                           <span class="ml-3">{{ $usuari->telefon }}</span>
                           </a>
                        </div>
                     </div>
                  </div>
